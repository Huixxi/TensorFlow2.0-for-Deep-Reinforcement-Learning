"""
A simple version Double Deep Q-Network(DDQN) minimal change to DQN.
To play CartPole-v0.
...
class DDQNAgent:
    def __init__(self, model, target_model, env, buffer_size=150, learning_rate=.001, epsilon=.1, epsilon_dacay=0.995, min_epsilon=.01,
                 gamma=.9, batch_size=8, target_update_iter=400, train_nums=5000, start_learning=100):
        self.model = model
